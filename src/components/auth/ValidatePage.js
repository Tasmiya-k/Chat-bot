...
function ValidatePage() {
  ...
  const [confirmationCode, setAuthenticationCode] = useState();

  async function handleRegisterConfirmation({ username, confirmationCode }) {
    try {
        ...
        <Col sm={6}>
          <Form>
            ...
            <Button
              ...
              type="button"
              onClick={() =>
                handleRegisterConfirmation({ username, confirmationCode })
              }
            >
              Validate &gt;&gt;
            </Button>
